...
const Placeorder = () => {
  ...
  const placeOrder = async (e) => {                           //small p
    e.preventDefault()                                        //will not reload the webpage
    let orderItems = [];
    food_list.map((item) => {
  ...
  return (
    <form onSubmit={placeOrder} className='place-order'>
      ...
      <div className="cart-total">
          ...
          <button type='submit'>PROCEED TO PAYMENT</button> {/*this will navigate to /order i.e placeorder page*/}
        </div>
      </div>
